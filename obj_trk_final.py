...
def drawBox(img,bbox):
    ...
    cv2.putText(img, 'Tracking..', (100,100), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8, (0,255,255), 1)
    pass
...
while True:
   ...
   if success:
       ...
       cv2.putText(img, 'Unable to track', (75,90), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0,0,255), 2)
